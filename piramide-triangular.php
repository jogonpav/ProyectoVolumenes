...
<ul class="nav" id="button">
    ...
    <h1><?php echo "Cálculos de Áreas y Volúmenes" ?></h1>
     <br/>
     <h2><?php echo "Área y volúmen de Piramide Triangular Regular" ?></h2>
     <h3><?php echo "Pirámide triangular regular conformada por una base de un triángulo equilátero con todos sus lados iguales, con triángulos laterales con lados iguales" ?></h3>
    
	 

     <div class="contenedor">
    <div>
    	<img class="imganfigu"src="/ProyectoVolumenes/imagenes/Piramide-triangular-regular.jpg">
    </div>
    <div>
		...
		error_reporting(0); 	//evita otros mensajes de error
			...
			if (empty($OrtA) || empty($OrtL) || empty($OrtH)) //Valida que no quede datos sin cargar por el usuario
				...
				{ echo '<br/><strong>¡ERROR!</strong>...Por favor introduzca todos los lados<br/><br/>';}
						...
						$area = ((sqrt(3)/2)*$OrtL)*(((1/2)*$OrtL)+sqrt(3)*$OrtA);
						$volumen = (sqrt(3)/12)*$OrtL*$OrtL*$OrtH;
